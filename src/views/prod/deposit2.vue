...
<script>
  ...
  import EventForm from './EventFormPord';
  import VWidget from '@/components/VWidget';
  import VuePerfectScrollbar from 'vue-perfect-scrollbar';
  import accountingPlain from './components/accountingPlain'
  import AcctForm from './AcctFormPord';
  import downAction from './tableProd/downAction'
  export default {
    name: 'deposit',
    components: {
        accountingPlain,
