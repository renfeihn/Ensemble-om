            ...
            <v-flex lg9 sm9 class="v-card elevation-2">
                ...
                <v-tabs-items v-model="activeName" class="white elevation-2 textProd">
                    <v-tab-item v-for="i in prodInfo" :key="i.pageCode">
                            ...
                            <base-prod :showEdit="showEdit" v-if="i.pageCode=='DEBT'" :prodTypeCode="prodData.prodType.prodType" :prodDefines="drawList" tags="DEBT" :disablePower="disablePower"></base-prod>
