      ...
      <v-card-text>
        <v-layout row wrap>
          ...
          <v-flex xs6 class="field-single-line">
            ...
            <v-text-field label="产品类型" name="title" v-model="prodtypeData" single-line>
            </v-text-field>
          </v-flex>
          <!-- <v-flex xs1/> -->
          <v-flex xs6 class="field-single-line">
            <span class="primary--text mx-3 pt-4 subheading">产品描述</span>
            <v-text-field label="产品描述" name="title" v-model="proddescData" single-line/>
          </v-flex>
          <!-- <v-flex xs1/> -->
        </v-layout>
        <v-layout row wrap>
          ...
          <v-flex xs6 class="field-single-line">
            ...
            <v-select :items="busimodel" v-model="busimodelData" label="业务模块" item-text="prodDesc" item-value="prodCode" single-line></v-select>
          </v-flex>
          <!-- <v-flex xs2/> -->
          <v-flex xs6 class="field-single-line">
            <span class="primary--text mx-3 pt-4 subheading">产品分类</span>
            <v-select :items="prodclass" v-model="prodclassData" label="产品分类" item-text="prodDesc" item-value="prodCode" single-line></v-select>
          </v-flex>
          <!-- <v-flex xs1/> -->
        </v-layout>
        <v-layout row wrap>
          ...
          <v-flex xs6 class="field-single-line">
            ...
            <v-select :items="prodprepice" v-model="prodprepiceData" label="产品属性" item-text="prodDesc" item-value="prodCode" single-line></v-select>
          </v-flex>
          <!-- <v-flex xs2/> -->
          <v-flex xs6 class="field-single-line">
            <span class="primary--text mx-3 pt-4 subheading">组合产品</span>
            <v-select :items="prodmuti" v-model="prodmutiData" label="组合产品" item-text="prodDesc" item-value="prodCode" single-line></v-select>
          </v-flex>
          <!-- <v-flex xs1/> -->
        </v-layout>
        <v-layout row wrap>
          ...
          <v-flex xs6 class="field-single-line">
            ...
            <v-select :items="prodstatus" v-model="prodstatusData" label="产品状态" item-text="prodDesc" item-value="prodCode" single-line></v-select>
          </v-flex>
          <!-- <v-flex xs2/> -->
          <v-flex xs6 class="field-single-line">
            <span class="primary--text mx-3 pt-4 subheading">基础产品 *</span>
            <v-select :items="baseprod" v-model="baseprodData" label="基础产品" item-text="prodDesc" item-value="prodCode" single-line></v-select>
          </v-flex>
          <!-- <v-flex xs1/> -->
        </v-layout>
        <v-layout row wrap>
          ...
          <v-flex xs6 class="field-single-line">
            ...
            <v-select :items="accttype" v-model="accttypeData" label="账户类型" item-text="prodDesc" item-value="prodCode" single-line></v-select>
          </v-flex>
          <!-- <v-flex xs2/> -->
          <v-flex xs6 class="field-single-line">
            <span class="primary--text mx-3 pt-4 subheading">账户子类型</span>
            <v-select :items="acctsontype" v-model="acctsontypeData" label="账户子类型" item-text="prodDesc" item-value="prodCode" single-line></v-select>
          </v-flex>
          <!-- <v-flex xs1/> -->
        </v-layout>
        <v-layout row wrap>
          ...
          <v-flex xs6 class="field-single-line">
            ...
            <v-select :items="acctstruct" v-model="acctstructData" label="账户结构" item-text="prodDesc" item-value="prodCode" single-line></v-select>
          </v-flex>
          <!-- <v-flex xs2/> -->
          <v-flex xs6 class="field-single-line">
            <span class="primary--text mx-3 pt-4 subheading">虚实标志</span>
            <v-select :items="virtualflag" v-model="virtualflagData" label="虚实标志" item-text="prodDesc" item-value="prodCode" single-line></v-select>
          </v-flex>
          <!-- <v-flex xs1/> -->
        </v-layout>
        <v-layout row wrap>
          <!-- <v-flex xs1/> -->
          <v-flex xs6 class="field-single-line">
            <span class="primary--text mx-3 pt-4 subheading">账户计息标志</span>
            <v-select :items="acctintflag" v-model="acctintflagData" label="账户计息标志" item-text="prodDesc" item-value="prodCode" single-line></v-select>
          </v-flex>
          <!-- <v-flex xs2/> -->
          <v-flex xs6 class="field-single-line">
            <span class="primary--text mx-3 pt-4 subheading">金额标志</span>
            <v-select :items="amtflag" v-model="amtflagData" label="金额标志" item-text="prodDesc" item-value="prodCode" single-line></v-select>
          </v-flex>
          <!-- <v-flex xs1/> -->
        </v-layout>
        <v-layout row wrap>
          ...
          <v-flex xs6 class="field-single-line">
            ...
            <v-select :items="profitcenter" v-model="profitcenterData" label="利润中心" item-text="prodDesc" item-value="prodCode" single-line></v-select>
          </v-flex>
        </v-layout>
        <v-layout row wrap>
          <!-- <v-flex xs1/> -->
          <v-flex xs6 class="field-single-line">
            <span class="primary--text mx-3 pt-4 subheading">生效日期</span>
          ...
          <!-- <v-flex xs2/> -->
          <v-flex xs6 class="field-single-line">
            <span class="primary--text mx-3 pt-4 subheading">失效日期</span>
