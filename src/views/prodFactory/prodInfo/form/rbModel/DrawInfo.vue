                ...
                <div slot="widget-content">
                    <v-container fluid pt-1>
                        <v-layout row wrap>
                            ...
                            <v-flex md4 lg4>
                                <v-select class="primary--text mx-2" :items="sourceModule" v-model="prodDefines.sourceModule" label="业务模块" item-text="value" item-value="key" single-line hide-details></v-select>
                            </v-flex>
                            <v-flex xs12 md2 lg2>
                            ...
                            <v-flex md4 lg4>
                                <v-select class="primary--text mx-2" :items="ccy" v-model="prodDefines.ccy" label="币种" item-text="value" item-value="key" ref="ccy" single-line hide-details></v-select>
                            </v-flex>
                            <v-flex xs12 md2 lg2>
