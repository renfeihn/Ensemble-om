          ...
          <v-container fluid pt-1>
            <v-layout row wrap>
             <v-flex xs12 md2 lg2>
              ...
              <v-flex md4 lg4>
                <v-text-field class="primary--text mx-1" label="同客户允许最大数量" name="prefix" v-model="prodtypeData" single-line hide-details>
                </v-text-field>
              </v-flex>
              <v-flex xs12 md2 lg2>
              ...
              <v-flex md4 lg4>
                          <v-text-field class="primary--text mx-1" label="最大倒起息天数" name="prefix" v-model="prodtypeData" single-line hide-details>
                          </v-text-field>
              </v-flex>
              <v-flex xs12 md2 lg2>
              ...
              <v-flex md4 lg4>
                         <v-text-field class="primary--text mx-1" label="最大起息天数" name="prefix" v-model="prodtypeData" single-line hide-details>
                         </v-text-field>
              </v-flex>
            </v-layout>
          </v-container>
...
export default {
  ...
  methods: {
    ...
    initRefDate() {
        ...
        this.structureType = response.data.paraDataRb.structureType;
        this.checkWdrawnType = response.data.paraDataRb.checkWdrawnType;
        this.restraintFlag = response.data.paraDataRb.restraintFlag;
        this.withdrawTypeHandeling = response.data.paraDataRb.withdrawTypeHandeling;
        this.daiBanFlag = response.data.paraDataRb.daiBanFlag;
        this.clientAmtCheckFlag = response.data.paraDataRb.clientAmtCheckFlag;
        this.startDepositAmt = response.data.paraDataRb.startDepositAmt;
       });
    },
    closeDialog() {
