  ...
  updateBaseInfo(val) {
    ...
    initRefDate() {
      getInitData().then(response => {
        ...
        this.draRange = response.data.paraDataRb.draRange;
        this.depRange = response.data.paraDataRb.depRange;
        this.tDepFlag = response.data.paraDataRb.tDepFlag;
        this.cashDepFlag = response.data.paraDataRb.cashDepFlag;
