...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            updateBaseInfo(val) {
                this.controlInfo = {}
                this.controlInfo.draRange = val.prodDefines.AUTOMATIC_RANGE.attrValue
                this.controlInfo.depRange = val.prodDefines.CIR_EXCHANGE_RANGE.attrValue
                this.controlInfo.tDepFlag = val.prodDefines.TRAN_CIR_EXCG_FLAG.attrValue
                this.controlInfo.cashDepFlag = val.prodDefines.CASH_CIR_EXCG_FLAG.attrValue
                this.controlInfo.clientFlag = val.prodDefines.CLIENT_CONTRAL_FLAG.attrValue
                this.controlInfo.channelFlag = val.prodDefines.CHANNEL_CONT_FLAG.attrValue
                this.controlInfo.branchControlFlag = val.prodDefines.BRC_AREA_CONT_FLAG.attrValue
                this.controlInfo.chargeFlag = val.prodDefines.CHARGE_TYPE.attrValue
                this.controlInfo.moveFlag = val.prodDefines.STATUS_TRAN_FLAG.attrValue
            },
            selectByProd() {
