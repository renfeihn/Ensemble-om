                ...
                <div slot="widget-content">
                    <v-container fluid pt-1>
                        <v-layout row wrap>
                            ...
                            <v-flex md4 lg4>
                                <v-select class="primary--text mx-2" :items="branchChoice" v-bind:value="productObject.branchChoice | getValues" label="机构选择" item-text="value" item-value="key" multiple single-line hide-details></v-select>
                            </v-flex>
                        </v-layout>
                    </v-container>
                </div>
